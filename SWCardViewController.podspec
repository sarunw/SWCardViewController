#
# Be sure to run `pod lib lint SWCardViewController.podspec' to ensure this is a
...
#                       DESC
  ...
  s.source_files = 'SWCardViewController/Classes/**/*'
  
  # s.resource_bundles = {
  #   'SWCardViewController' => ['SWCardViewController/Assets/*.png']
  # }
